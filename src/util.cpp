...
const char * const BITCOIN_CONF_FILENAME = "ragecoin.conf";
const char * const BITCOIN_PID_FILENAME = "ragecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ragecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ragecoin";
#else
    // Unix
    return pathRet / ".ragecoin";
#endif
#endif
}
