...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ragecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ragecoin-tx [options] <hex-tx> [commands]  Update hex-encoded ragecoin transaction\n" +
            "or:     ragecoin-tx [options] -create [commands]   Create hex-encoded ragecoin transaction\n" +
            "\n";
