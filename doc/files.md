...
* ragecoin.conf: contains configuration settings for ragecoind or ragecoin-qt
* ragecoind.pid: stores the process id of ragecoind while running
...
* debug.log: contains debug information and general logging generated by ragecoind or ragecoin-qt
