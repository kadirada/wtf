# Support for Output Descriptors in Ragecoin Core

Since Ragecoin Core v0.17, there is support for Output Descriptors in the
...
on Ragecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Ragecoin Core wallets, a convenience function `combo` is
