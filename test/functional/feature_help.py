...
"""Verify that starting ragecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ragecoin with -h for help text")
        ...
        self.log.info("Start ragecoin with -version for version information")
        ...
        self.log.info("Start ragecoind with -fakearg to make sure it does not start")
